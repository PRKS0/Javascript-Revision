...
const sliced = num1.slice(1, 3)    
console.log(sliced);
console.log(num1);

const spliced = num1.splice(1, 4)   
console.log(spliced);
console.log(num1);

//difference between slice and splice
//slice: array.slice(index-start, index-end) last index is not included, sliced array will not modify
//splice: array.splice(index-start, number-of-element-to-delete), spliced array will be modify